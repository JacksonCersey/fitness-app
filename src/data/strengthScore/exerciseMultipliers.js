...
const EXACT_MULTIPLIERS = {
  ...
  'inverted row': 0.82,
  'push up': 0.72,
  'explosive push up': 0.7,
  'machine chest press': 0.62,
  'pec deck fly': 0.4,
  'machine seated row': 0.65,
  'incline dumbbell shoulder press': 0.75,
  'machine shoulder press': 0.62,
  dip: 0.78,
  'chest dip': 0.78,
  'hip thrust': 0.88,
  'glute bridge': 0.75,
...
const PATTERN_MULTIPLIERS = [
  ...
  { includes: ['push up', 'push-up', 'pushup'], multiplier: 0.72, category: 'compound' },
  { includes: ['shoulder press'], multiplier: 0.75, category: 'compound' },
